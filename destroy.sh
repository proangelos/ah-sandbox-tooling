...
# create.sh drops per-sandbox README.md/AGENTS.md/CLAUDE.md files alongside
# the repo worktrees; clear them so rmdir below isn't blocked by a leftover
# file.
rm -f "$sandbox_dir/README.md" "$sandbox_dir/AGENTS.md" "$sandbox_dir/CLAUDE.md"
